...
public class CustomerDetail extends javax.swing.JFrame {
    ...
    public CustomerDetail() {
        ...
        addressDetails = new JButton("Address Details");
        addressDetails.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveCustomerAddress(evt);
            }
        });
    ...
    public CustomerDetail(BankCustomer customer) {
        ...
        accounts = AccountDTO.getAccountsByCustomerId(customer.getCustomerNumber());

        String[] accountDetails = new String[accounts.size()];

        for (int i = 0; i < accounts.size(); i++) {
            BankAccount account = accounts.get(i);
            accountDetails[i] = account.toString();
        }
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = accountDetails;
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
    ...
    private void actDetailActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedIndex != -1) {
            ...
            AccountDetail addressDetailFrame = new AccountDetail(selectedAccount);
            addressDetailFrame.setVisible(true);
        }
    }
    ...
    private void saveCustomerAddress(java.awt.event.ActionEvent evt) {
        CustomerAddress customerAddressFrame = new CustomerAddress(customer);
        customerAddressFrame.setVisible(true);
    }

    private void saveCustomer(java.awt.event.ActionEvent evt) {

        String updatedFirstName = jTextField1.getText();
        String updatedLastName = jTextField2.getText();
        String updatedEmail = jTextField3.getText();
        String updatedPhone = jTextField4.getText();
    ...
    private javax.swing.JButton addressDetails;
