...
public class AccountDataConnection extends DataConnection {
    ...
    private static final String SELECT_SQL_BYID = "SELECT * FROM bankaccount WHERE cust_id = ?";
    private static final String UPDATE_SQL = "UPDATE bankaccount SET acct_type = ? WHERE acct_num = ?";
