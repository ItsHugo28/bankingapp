...
public class CustomerAddressDAO implements DAOInterface<CustomerAddress> {
    ...
    public static ResultSet getCustomerIdsByCity(String city) throws SQLException {
        Connection connection = DataConnection.getDBConnection();
        PreparedStatement preparedStatement = connection.prepareStatement(AddressDataConnection.GET_CUSTID_BY_CITY_QUERY);
