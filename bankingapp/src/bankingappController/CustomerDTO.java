...
public class CustomerDTO {
    ...
    public static List<BankCustomer> findCustomer(String city) throws SQLException {
        List<Integer> customerIds = CustomerAddressDTO.getCustomerIdsByCity(city);
        if (customerIds.isEmpty()) {
            System.out.println("No customers found in the specified city.");
            return new ArrayList<>(); // Return an empty list if no customers found
        }
        return CustomerDAO.searchCustomersByIds(customerIds);
    }
}