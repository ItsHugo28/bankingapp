...
public class AccountTransactionDTO {
    ...
    public static List<BankAccountTransaction> transactionsByAccountID(int anId) {
        List<BankAccountTransaction> transactions = new ArrayList<>();
        try {
            transactions = ato.getTransactionsByAccountID(anId);
            for (BankAccountTransaction transaction : transactions) {
                System.out.println("\nFetched transaction with Account ID: " + anId + " Transaction Details:\n" + transaction.toString());
            }
